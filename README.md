...
- Validates and compiles all 22 Source 2 resources in the selected integrated payload.
...
Verify the live Top Bar Plus V40D and both ShowRank Barebones fixtures, then generate both 22-resource VPKs:
